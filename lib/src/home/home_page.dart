...
import 'package:portfolio/src/constants/fonts.dart';
import 'package:portfolio/src/constants/strings.dart';
import 'package:portfolio/src/constants/text_styles.dart';
import 'package:portfolio/src/models/education.dart';
import 'package:portfolio/src/widget/responsive.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
          ...
          body: Padding(
            padding: ResponsiveWidget.isLargeScreen(context) ? EdgeInsets.symmetric(horizontal: 100) : EdgeInsets.symmetric(horizontal: 20),
  ...
  Widget _buildTitle() {
    return Padding(
      padding: ResponsiveWidget.isLargeScreen(context) ? EdgeInsets.symmetric(horizontal: 104) : null,
          child: RichText(
        text: TextSpan(
  ...
  Widget _buildEducationSummary() {
    return Text(
      'I have 6 years experience in Mobile application development and backened services',
      style: TextStyles.body,
    );
  }
          ...
          onTap: () {
            ...
            showDialog(
              ...
              builder: (BuildContext context) {
                return showAlert('LinkedIn','www.linkedin.com/ishaileshmishra');
              },);
          },
          child: Image.network(
            Assets.linkedin,
        ...
        GestureDetector(
          onTap: () {
            showDialog(
              context: context,
              builder: (BuildContext context) {
                return showAlert('Medium','https://medium.com/@ishaileshmishra');
              },);
          },
          child: Image.network(
            Assets.evernote,
        ...
        GestureDetector(
          onTap: () {
            showDialog(
              context: context,
              builder: (BuildContext context) {
                return showAlert('Github','https://github.com/ishaileshmishra');
              },);
          },
          child: Image.network(
            Assets.google,
        ...
        GestureDetector(
          onTap: () {
            showDialog(
              context: context,
              builder: (BuildContext context) {
                return showAlert('Twitter','https://twitter.com/ishailesmishra');
              },);
          },
          child: Image.network(
            Assets.twitter,
  ...
  Widget showAlert(String title, String description){
